...
function renderBossName(name){const color=bossEventColor(name),eventClass=color?" boss-event":"";return `<span class="bossName ${bossClass(name)}${eventClass}"${color?` style="--boss-event-color:${color}"`:""}>${escapeHtml(name)}</span>`}
