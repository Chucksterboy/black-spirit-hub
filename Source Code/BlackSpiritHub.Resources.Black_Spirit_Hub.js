...
const couponState={initialized:false,coupons:[],activeTab:"available",selectedCode:"",page:0,pageSize:8,timer:null,autoTimer:null,autoRefreshing:false,lastKnownCodes:new Set((Array.isArray(storedCouponKnownCodes)?storedCouponKnownCodes:[]).map(couponCodeKey).filter(Boolean))};
